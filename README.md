...
### 📋 Lista de Scripts
- 📥 [Instalação automatizada do GLPI no Oracle Linux 8](https://github.com/serviceticst/grafana/releases/tag/1.0.0)
...
- 📥 [Automated Grafana Installation on Oracle Linux 8](https://github.com/serviceticst/grafana/releases/tag/1.0.0)
